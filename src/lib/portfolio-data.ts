export type HeadlinePart =
  | { type: "text"; v: string }
  | { type: "br" }
  | { type: "typed"; v: string; alts: readonly string[] };

export type MetaItem = { k: string; v: string };
export type AboutBullet = { w: string; d: string };
export type TimelineEntry = { year: string; role: string; desc: string };
...
export type SkillItem = { t: string; s: string };
...
export type Skills = {
  core: SkillGroup;
  integrations: SkillGroup;
  devops: SkillGroup;
  ways: SkillGroup;
  langs: SkillGroup;
};

export type Cert = { badge: string; t: string; s: string };
...
export type Portfolio = {
  ...
  linkedin: string;
  github: string;
  headline: { parts: readonly HeadlinePart[] };
  sub: string;
  meta: readonly MetaItem[];
  aboutBullets: readonly AboutBullet[];
  timeline: readonly TimelineEntry[];
  capabilities: readonly Capability[];
  skills: Skills;
  certs: readonly Cert[];
  rdProjects: readonly string[];
};
